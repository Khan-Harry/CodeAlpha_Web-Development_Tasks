  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', width: '100vw' }}>
      <div className="glass" style={{ width: '100%', maxWidth: '420px', padding: '40px', textAlign: 'center' }}>
        <h2 style={{ fontSize: '2rem', marginBottom: '8px', color: '#fff' }}>Get Started</h2>
        <p style={{ color: '#94a3b8', fontSize: '0.9rem', marginBottom: '32px' }}>Create an account to collaborate on projects</p>
        ...
        <p style={{ color: '#94a3b8', fontSize: '0.85rem', marginTop: '24px' }}>
          Already have an account? <Link to="/login" style={{ color: '#a855f7', textDecoration: 'none', fontWeight: '600' }}>Sign in</Link>
        </p>
      </div>
    </div>
  );
